...
public class CT006Steps extends ValidationUtil {

  private final TeamResource teamResource;

  private final Logger logger = LoggerFactory.getLogger(CT006Steps.class);
  ...
  public CT006Steps(TeamResource teamResource) {
    this.teamResource = teamResource;
  }

  @Given("I perform a POST request for {string} informing a Pokemon that not exists in field fourthPokemon")
  public void IPerformAPostRequestForTeamInformingAPokemonThatNotExistsInFieldFourthPokemon(String path) {
    ...
    requestBody.put("fourthPokemon", "Teste");
  ...
  @Then("Verify if returning the message for pokemon that not exists in field fourthPokemon {string} and response code {string}")
  public void VerifyIfReturningTheMessageForPokemonThatNotExistInFieldFourthPokemon(String statusDescription, String statusCode) {
    String pathBody = "[0]";
