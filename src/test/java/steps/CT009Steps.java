...
public class CT009Steps extends ValidationUtil {

  private final TeamResource teamResource;

  private final Logger logger = LoggerFactory.getLogger(CT009Steps.class);
  ...
  public CT009Steps(TeamResource teamResource) {
    this.teamResource = teamResource;
  }

  @Given("I perform a POST request for {string} not informing the field firstPokemon")
  public void IPerformAPostRequestForTeamNotInformingTheFieldFirstPokemon(String path) {
  ...
  @Then(
      "Verify if returning the message not informing the field firstPokemon {string} and response code {string}")
  public void VerifyIfReturningTheMessageNotInformingTheFieldFirstPokemon(
