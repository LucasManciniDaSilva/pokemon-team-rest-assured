...
public class CT012Steps extends ValidationUtil {

  private final TeamResource teamResource;

  private final Logger logger = LoggerFactory.getLogger(CT012Steps.class);
  ...
  public CT012Steps(TeamResource teamResource) {
    this.teamResource = teamResource;
  }

  @Given("I perform a POST request for {string} not informing the field fourthPokemon")
  public void IPerformAPostRequestForTeamNotInformingTheFieldFourthPokemon(String path) {
  ...
  @Then(
      "Verify if returning the message not informing the field fourthPokemon {string} and response code {string}")
  public void VerifyIfReturningTheMessageNotInformingTheFieldFourthPokemon(
