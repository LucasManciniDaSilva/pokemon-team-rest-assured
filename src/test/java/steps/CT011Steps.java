...
public class CT011Steps extends ValidationUtil {

  private final TeamResource teamResource;

  private final Logger logger = LoggerFactory.getLogger(CT011Steps.class);
  ...
  public CT011Steps(TeamResource teamResource) {
    this.teamResource = teamResource;
  }

  @Given("I perform a POST request for {string} not informing the field thirdPokemon")
  public void IPerformAPostRequestForTeamNotInformingTheFieldThirdPokemon(String path) {
  ...
  @Then(
      "Verify if returning the message not informing the field thirdPokemon {string} and response code {string}")
  public void VerifyIfReturningTheMessageNotInformingTheFieldThirdPokemon(
